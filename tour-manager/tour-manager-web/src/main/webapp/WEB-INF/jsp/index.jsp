    ...
    <div id="menu" class="easyui-accordion">
        <div title="商品管理" data-options="selected:true,iconCls:'icon-tip'" style="padding:10px 0;">
            <ul class="easyui-tree">
                <li data-options="attributes:{'href':'user-list'}">用户管理</li>
                <li data-options="attributes:{'href':'city-list'}">城市管理</li>
                <li data-options="attributes:{'href':'order-list'}">订单管理</li>
                <li data-options="attributes:{'href':'view-list'}">景点管理</li>
                <li data-options="attributes:{'href':'hotel-list'}">酒店管理</li>
            </ul>
        </div>
